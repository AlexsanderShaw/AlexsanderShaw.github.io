...
该函数主要用于将新的test case添加到队列，初始化 `fname` 文件名称，增加`cur_depth` 深度，增加 `queued_paths` 测试用例数量等。
...
![image-20210908115123089](https://cdn.jsdelivr.net/gh/AlexsanderShaw/BlogImages@main/img/vuln/shebei20210908115123.png)
...
![未命名绘图.drawio](https://cdn.jsdelivr.net/gh/AlexsanderShaw/BlogImages@main/img/vuln/shebei20210908165212.png)

对于fuzzer和目标程序之间的通信状态我们可以通过下图来梳理：

![未命名绘图.drawio](https://cdn.jsdelivr.net/gh/AlexsanderShaw/BlogImages@main/img/vuln/shebei20210908170232.png)
...
![image-20210909111119930](https://cdn.jsdelivr.net/gh/AlexsanderShaw/BlogImages@main/img/vuln/shebei20210909111120.png)
...
![image-20210909141024743](https://cdn.jsdelivr.net/gh/AlexsanderShaw/BlogImages@main/img/vuln/shebei20210909141025.png)
...
![image-20210909164334608](https://cdn.jsdelivr.net/gh/AlexsanderShaw/BlogImages@main/img/vuln/shebei20210909164334.png)
