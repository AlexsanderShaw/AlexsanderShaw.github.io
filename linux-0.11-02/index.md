...
![图片](https://cdn.jsdelivr.net/gh/AlexsanderShaw/BlogImages@main/img/202112131037519)
...
![图片](https://cdn.jsdelivr.net/gh/AlexsanderShaw/BlogImages@main/img/202112131037020)
...
![图片](https://cdn.jsdelivr.net/gh/AlexsanderShaw/BlogImages@main/img/202112131037552)
...
![图片](https://cdn.jsdelivr.net/gh/AlexsanderShaw/BlogImages@main/img/202112131038034)
...
![图片](https://cdn.jsdelivr.net/gh/AlexsanderShaw/BlogImages@main/img/202112131038294)

正如我们本回所涉及到的讲述一样，**CS 是代码段寄存器**，就是执行代码的时候带着这里存的基地址。**DS 是数据段寄存器**，就是访问数据的时候带着这里的基地址。**SS 是栈段寄存器**，就是访问栈时带着这里的基地址。

![图片](https://cdn.jsdelivr.net/gh/AlexsanderShaw/BlogImages@main/img/202112131038606)
...
![图片](https://cdn.jsdelivr.net/gh/AlexsanderShaw/BlogImages@main/img/202112131038851)
...
![图片](https://cdn.jsdelivr.net/gh/AlexsanderShaw/BlogImages@main/img/202112131038894)
...
![图片](https://cdn.jsdelivr.net/gh/AlexsanderShaw/BlogImages@main/img/202112131038168)
...
![图片](https://cdn.jsdelivr.net/gh/AlexsanderShaw/BlogImages@main/img/202112131038725)

所以，我们即将跳转到的内存中的 **0x90200** 处的代码，就是从硬盘第二个扇区开始处加载到内存的。第二个扇区的最开始处，那也就是 setup.s 文件的第一行代码咯。

![图片](https://cdn.jsdelivr.net/gh/AlexsanderShaw/BlogImages@main/img/202112131038374)
...
![图片](https://cdn.jsdelivr.net/gh/AlexsanderShaw/BlogImages@main/img/202112131038205)
...
![图片](https://cdn.jsdelivr.net/gh/AlexsanderShaw/BlogImages@main/img/202112131038357)
...
![图片](https://cdn.jsdelivr.net/gh/AlexsanderShaw/BlogImages@main/img/202112131038726)

同前面的原理一样，也是做了个内存复制操作，最终的结果是，把内存地址 **0x10000** 处开始往后一直到 **0x90000** 的内容，统统复制到内存的最开始的 **0** 位置，大概就是这么个效果。

![图片](https://cdn.jsdelivr.net/gh/AlexsanderShaw/BlogImages@main/img/202112131038517)
...
![图片](https://cdn.jsdelivr.net/gh/AlexsanderShaw/BlogImages@main/img/202112131038452)
